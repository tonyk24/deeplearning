...
# Use the discriminator model to classify the generated image (positive or negative)
# Positive value for real images and negative values for fake images.
...
# Save models as checkpoints in case model training is interrupted
...
# This is the training loop where the generator begins with random noise
# and generates a image, the discrimantor is then used to classify image as
# fake or real, drawn from the training set. 
...
def train_step(images):
    ...
    with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
      ...
      tf.print(fake_output, output_stream=sys.stderr)
...
# Generate a images from the model, plot and save to file
...
# Runs the training loop for a number of epoch, generates and saves image for each step
...
# Display the last image generated
